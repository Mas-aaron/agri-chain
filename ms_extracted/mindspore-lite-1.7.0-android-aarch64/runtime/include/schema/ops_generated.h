...
enum PrimitiveType : uint8_t {
  ...
  PrimitiveType_MAX = PrimitiveType_NLLLossGrad
};

inline const PrimitiveType (&EnumValuesPrimitiveType())[209] {
...
inline const char *EnumNamePrimitiveType(PrimitiveType e) {
  if (flatbuffers::IsOutRange(e, PrimitiveType_NONE, PrimitiveType_NLLLossGrad)) return "";
